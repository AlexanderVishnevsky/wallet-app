...
import SecretPhraseModal from '@ui/common/SecretPhraseModal';
import { useNavigate } from 'react-router-dom';
import UpdateBalance from '@ui/common/UpdateBalance';
...
const Wallet = () => {
    ...
    return (
        <S.WalletLayout>
            ...
            {showSecret && <SecretPhraseModal handleClose={toggleModal} />}
        </S.WalletLayout>
    );
};
